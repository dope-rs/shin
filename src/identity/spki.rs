...
impl SubjectPublicKey {
    pub(crate) fn encoded_ed25519(public_key: &[u8; 32]) -> [u8; ED25519_SPKI_LEN] {
        let mut encoded = [0; ED25519_SPKI_LEN];
        encoded[..ED25519_SPKI_PREFIX.len()].copy_from_slice(&ED25519_SPKI_PREFIX);
        encoded[ED25519_SPKI_PREFIX.len()..].copy_from_slice(public_key);
        encoded
    }
